...
class GewearCanvasInit extends AbstractMigration
{
    public function up()
    {
        ...
        $table = $this->table('company_settings', ['id' => false, 'primary_key' => ['company_id', 'name'], 'engine' => 'InnoDB', 'encoding' => 'utf8', 'collation' => 'utf8_general_ci', 'comment' => '', 'row_format' => 'Compact']);
...
- modulo leads, agent default, rotation default , etc'])
            ...
            ->addColumn('value', 'text', ['null' => false, 'limit' => 65535, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'name'])
        ...
        $table->addColumn('id', 'string', ['null' => false, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8'])
            ...
            ->addColumn('token', 'text', ['null' => false, 'limit' => 65535, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'users_id'])
...
- etc'])
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_BIG, 'precision' => 19, 'identity' => 'enable'])
            ->addColumn('email', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'id'])
            ->addColumn('password', 'string', ['null' => true, 'limit' => 255, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'email'])
            ...
            ->addColumn('displayname', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'default_company'])
            ->addColumn('registered', 'datetime', ['null' => true, 'after' => 'displayname'])
            ->addColumn('lastvisit', 'datetime', ['null' => true, 'after' => 'registered'])
            ->addColumn('sex', 'char', ['null' => true, 'limit' => 1, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'lastvisit'])
            ->addColumn('timezone', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'sex'])
            ...
            ->addColumn('profile_privacy', 'char', ['null' => true, 'limit' => 1, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'country_id'])
            ->addColumn('profile_image', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'profile_privacy'])
            ->addColumn('profile_header', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'profile_image'])
            ->addColumn('profile_header_mobile', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'profile_header'])
            ...
            ->addColumn('user_activation_key', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'welcome'])
            ->addColumn('user_activation_email', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'user_activation_key'])
            ->addColumn('user_activation_forgot', 'string', ['null' => true, 'limit' => 45, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'user_activation_email'])
            ->addColumn('language', 'string', ['null' => true, 'limit' => 5, 'collation' => 'utf8_general_ci', 'encoding' => 'utf8', 'after' => 'user_activation_forgot'])
